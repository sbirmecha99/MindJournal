                  ...
                  return (
                    ...
                    >
                      <div className="flex justify-between items-start">
                        <div
                          className={`flex items-center justify-center w-8 h-8 rounded-full text-md font-libre-baskerville font-medium
                          ${
                            day.isToday
                      ...
                      {day.entries.length > 0 && (
                        <div className="mt-2 flex justify-center">
                          <div className="text-xs px-2 py-1 rounded-full bg-primary-500 text-white font-libre-baskerville font-light">
                            {day.entries.length}{" "}
