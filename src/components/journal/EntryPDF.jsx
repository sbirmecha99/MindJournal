...
const EntryPDF = ({ entry }) => {
  ...
  const randomQuote =
    psychologyQuotes[Math.floor(Math.random() * psychologyQuotes.length)];
  ...
  return (
    <>
      {/* Removed the Google Fonts links below since the fonts I stated above for the inline styles section were already imported in index.css and defined in tailwing.config.js for global usage.*/}
